...
namespace LIBRARY_SYSTEM.LMSDataSet3TableAdapters {
...
SELECT book_id, title, author_id, isbn, genre_id, publication_year, publication_id, edition, language, description, price, copies_avl, total_copies FROM BOOKS WHERE (book_id = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(LMSDataSet3.BOOKSDataTable dataTable) {
        ...
        public virtual LMSDataSet3.BOOKSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LMSDataSet3.BOOKSDataTable dataTable = new LMSDataSet3.BOOKSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LMSDataSet3.BOOKSDataTable dataTable) {
